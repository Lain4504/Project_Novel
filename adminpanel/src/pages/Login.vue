...
<template>
  <section class="bg-gray-50 min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div class="hidden md:block md:w-1/2 bg-indigo-600 text-white p-10">
        ...
        <div class="mt-10">
          <img
            ...
            class="rounded-lg shadow-lg w-[600px] object-cover object-center"
          />
        </div>
      </div>
      ...
      <div class="w-full md:w-1/2 p-6 sm:p-10 max-w-md md:max-w-lg mx-auto">
        ...
        <form class="mt-8 space-y-6">
          ...
          <div class="relative">
            ...
            />
            <!-- Custom Toggle Icon -->
            <span @click="togglePasswordVisibility" class="absolute right-3 bottom-[0.68rem] text-gray-500 cursor-pointer">
