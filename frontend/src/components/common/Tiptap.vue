...
<template>
  <div>
    <section v-if="editor" class="text-gray-600 flex items-center flex-wrap gap-x-4 border-t border-r border-l border-gray-300 p-4 bg-gray-100 shadow-sm rounded-t">
