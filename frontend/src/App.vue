...
const routesIncludeHome = ['home', 'chapter', 'noveldetail', 'userprofile', 'member','list', 'bookmark', 'readinglist', 'library', 'history', 'faq' ]; // Thêm các route bạn muốn hiển thị Header
