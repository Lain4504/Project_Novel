...
const loadingLatestNovels = ref(true);
const loadingTrendingBooks = ref(true);
...
const fetchLatestNovels = async () => {
  try {
    ...
    loadingLatestNovels.value = false;
  }
};
...
const fetchTrendingNovels = async () => {
  try {
    ...
    loadingTrendingBooks.value = false;
  }
};
  ...
  <div class="max-w-screen-xl mx-auto">
    <a-row :gutter="[24, 24]">
      ...
      <a-col :xs="24" :md="24" :lg="18">
        <a-card class="mb-6">
          <template #title>
            <a-typography-title :level="4" class="!mb-0">TIỂU THUYẾT MỚI</a-typography-title>
          </template>

          <a-skeleton :loading="loadingLatestNovels" active>
            <template #default>
      ...
      <a-col :xs="24" :md="24" :lg="6">
        <a-card title="Theo Dõi Nhiều" class="bg-gray-50">
          <a-skeleton :loading="loadingTrendingBooks" active>
            <template #default>
                    ...
                    <div class="flex items-center">
                      ...
                      <div class="ml-4">
                        <router-link
                            ...
                            class="hover:text-[#18A058]"
                        >
                          <a-typography-text strong class="text-sm">{{ book.title }}</a-typography-text>
                        </router-link>
                        <br />
