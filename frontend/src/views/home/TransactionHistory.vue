...
const transactions = ref<Transaction[]>([
  {
    id: 2617767,
    time: '2024-11-28 20:13:15',
    content: 'Mở khóa Chương 296: Thần tiên trứ yêu! Khách hành hướng tán đi!',
    transaction: -150
  },
  ...
  {
    id: 2613614,
    time: '2024-11-28 12:52:22',
    content: 'Mở khóa Chương 295: Người trong giang hồ không bị trói buộc',
    transaction: -140
  },
  ...
  <div class="max-w-7xl mx-auto">
    ...
    <div>
      <div class="flex justify-between items-center my-2">
        ...
        <button class="text-sm bg-green-400 border-[1px] hover:bg-green-400 hover:scale-105 font-medium py-2 px-4 rounded transition-all duration-300 flex items-center justify-center"
                @click="topUp">
          Deposit
        </button>
      ...
      <div class="mt-4 flex justify-between items-center my-4">
        <div class="flex items-center">
          <button :disabled="page === 1" class="text-sm bg-transparent border-[1px] border-blue-500 text-blue-500 hover:border-blue-700 hover:scale-105 font-medium py-2 px-4 rounded transition-all duration-300 flex items-center justify-center"
                  @click="previousPage">
          ...
          <ul class="inline-flex -space-x-px text-sm">
            <li v-for="n in totalPagesComputed" :key="n">
              <a :class="{ 'bg-blue-500 text-white': n === page, 'text-blue-500 hover:bg-blue-100': n !== page }"
          ...
          <button :disabled="page === totalPagesComputed" class="text-sm bg-transparent border-[1px] border-blue-500 text-blue-500 hover:border-blue-700 hover:scale-105 font-medium py-2 px-4 rounded transition-all duration-300 flex items-center justify-center"
                  @click="nextPage">
        ...
        <div class="flex items-center text-sm">
          <input v-model="pageInput" :max="totalPagesComputed" class="px-3 py-1 border rounded-md w-20" min="1"
                 placeholder="Jump to" type="number" @input="onPageInput"/>
