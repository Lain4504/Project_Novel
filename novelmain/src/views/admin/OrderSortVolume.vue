<template>
    <div class="p-5 border border-gray-300  mx-auto">
      <h3 class="text-xl font-semibold mb-4">Order</h3>
...
>
          <template #item="{ element }">
            <div class="bg-green-100 p-2 mb-2 rounded">
              {{ element.name }}
            </div>
          </template>
        </draggable>
      ...
      <div class="flex justify-between">
        <button @click="saveOrder" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600">Lưu thứ tự</button>
