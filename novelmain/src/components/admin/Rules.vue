<template>
    ...
    <p><strong>22:28 - 18/04/2020</strong></p>
    <p>Khi tham gia sử dụng dịch vụ cung cấp bởi Mê Truyện Chữ, bạn phải đồng ý và tuân thủ các quy định sau.</p>
    ...
    <ul>
        <li>Mê Truyện Chữ cung cấp dịch vụ trên internet.</li>
        <li>Khách hàng gọi tắt là KH, sử dụng dịch vụ của Mê Truyện Chữ trên internet.</li>
    </ul>

    <h2>Nội dung:</h2>
    <ul>
        <li>Không được có những từ ngữ gay gắt, đả kích, xúc phạm, bêu xấu cá nhân và tổ chức trên Mê Truyện Chữ.</li>
        ...
        <li>Không spam tin nhắn, bình luận, bài viết hay bất cứ hình thức nào tại Mê Truyện Chữ.</li>
        ...
        <li>Không tận dụng các bugs (lỗi) của chương trình nhằm phá hoại sự ổn định của Mê Truyện Chữ.</li>
        <li>Sẽ khóa vĩnh viễn các tài khoản copy truyện thu phí ra ngoài mà không được sự cho phép bằng văn bản của Mê Truyện Chữ.</li>
    ...
    <h2>Quy định khi đăng truyện</h2>
    <ul>
        ...
        <li>Tất cả truyện bạn đăng lên Mê Truyện Chữ có bản quyền thuộc về cá nhân của bạn, Mê Truyện Chữ không có quyền lợi hay nghĩa vụ đăng ký bản quyền hộ bạn. Khi đăng truyện lên hệ thống bạn cho phép Mê Truyện Chữ và các website thuộc hệ thống quyền khai thác quảng cáo và quyền thu hộ trả phí (mở khóa) các chương truyện trên các truyện bạn đã đăng.</li>
    </ul>
