package com.backend.searchservice.constant;
...
public class ElasticConstants {
    ...
    public static final String LAST_CHAPTER_NAME = "lastChapterName";
    public static final String LAST_CHAPTER_UPDATE_TIME = "lastChapterUpdateTime";
